...
| `governance/router-core-evolution.md` | ✅ 活跃 | 结构化路由内核演进方案：承接同事 SOP Router Core 的 graph / policy / capsule / eval 思想，明确渐进吸收路线和暂不切换边界 |
...
| `templates/skill-capsule.template.yml` | ✅ 活跃 | skill 轻量 capsule 模板：承接 SOP Router Core 的低风险思想，仅作为未来结构化路由评估模板，不改变现有 skill 加载方式 |
...
*最后更新：2026-05-15（补充禅道 Bug 编辑正文保全事故案例资产）*
